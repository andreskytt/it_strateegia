...
\begin{frame}[fragile]
  \frametitle{Õppe struktuur}
	...
	\item Kodutöö
	\begin{itemize}
		\item Grupis rohkem kui 1 ja vähem kui 6 inimest
		\item Ülesanne: \textbf{koostada ettevõtte IT strateegia}
		\item Osa hindest annab koostatu ette kandmine ja küsimustele vastamine
	\end{itemize}
	\end{itemize}
\end{frame}
  ...
  \frametitle{Õppe struktuur. Materjalid}
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Tegelen kursuse raames tehnoloogilise loenguinnovatsiooniga!
		\end{itemize}
	...
	\begin{itemize}
		...
		\item Tegelen põhimõtteliste asjadega
			\begin{itemize}
				...
				\item Pealisehitus on nii ehk naa liiga muutlik
			\end{itemize}
	\end{itemize}
\end{frame}
...
\begin{frame}[fragile]
  \frametitle{Arhitektuuri tavapärane käsitlus}
		...
		Akadeemilises vaates on arhitektuur viis millegi formaalseks kirjeldamiseks ja selle kirjelduseni jõudmiseks
		\begin{itemize}
...
\begin{frame}[fragile]
  \frametitle{Süsteemi piiridest}
		...
		\begin{itemize}
			\item Tavaliselt tõmmatakse piir nende osade ümber, mida kontrollitakse. See on viga (Yosemite näide) 
...
\begin{frame}[fragile]
  \frametitle{CFF mudel}
	Mudeli kirjeldus ja mõju. Concept kui seos kultuuriga.
\end{frame}
