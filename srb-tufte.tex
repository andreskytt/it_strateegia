...
\nohyphenation
Pühendatud kõigile, kes hinges patsi kannavad
\end{doublespace}
\vfill
\vfill
...
Ehk kõige olulisem Vitruviuse pärand on tema kolm üldist printsiipi, millele kõik ruumiga tegelevad kunstid alluma peaksid: tugevus (püsivus), otstarbekus, ilu.\cite{vitruviusest}. Tol ajal arvuteid polnud kuid samade printsiipide rakenduvuse vastu tänapäevases tarkvara arhitektuuris on raske vaielda. 
...
\begin{marginfigure}
	\begin{center}
		...
		\caption{Peter Senge\index{Peter Senge} (By Beyond My Ken - Own work, GFDL, \url{https://commons.wikimedia.org/w/index.php?curid=24627572}) ja Jay Forrester}
		\label{fig:legendid}
	\end{center}
\end{marginfigure}
...
\begin{marginfigure}
	\begin{center}
		...
		\label{fig:ed}
	\end{center}
	Kauaaegne MIT professor Ed Crawley\index{Edward Crawley} on töötanud koos NASAga ISSi kallal, asutanud mitmeid ettevõtteid ning olnud Skoltechi esimene rektor. Prof. Crawley süsteemiarhitektuuri üks vaieldamatuid suurkujusid maailmas.
\end{marginfigure}
