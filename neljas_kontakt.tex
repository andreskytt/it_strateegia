...
\begin{frame}[fragile]
  \frametitle{Strateegilised implikatsioonid}
	\begin{itemize}
		...
		\note{Sest puhta rakenduseni ei jõuta eales\par}
		\begin{itemize}
...
\begin{frame}[fragile]
  \frametitle{Kaizenist}
	...
	\begin{itemize}
		...
		\note{Kvaliteedi juhtimine ei seisne üle aia visatud koodi valideerimises kellegi arvamuse vastu süsteemi käitumisest}
  ...
  \frametitle{Teenuse mõõtmisest}
  	Mõõta ja hinnata tuleb teenust, mitte selle komponente
		\begin{itemize}
			...
			\item Eriti oluline mitte-boolean parameetrite korral
...
\begin{frame}[fragile]
  \frametitle{Modelleerimisest}
	...
	\note{Strateegiliselt väga riskantne samm. Räägin, sest olen seda kiusatust palju näinud ka mõistlike inimeste puhul}
		\begin{itemize}
