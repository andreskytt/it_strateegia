  ...
  \frametitle{Kogemused kodutööst}
  	\begin{itemize}
		...
		\begin{itemize}
			...
			\item On mõistlik eraldada end ettevõtte strateegilistest probleemidest
			\note{Kui organisatsioon on ebamõistlikult juhitud, tasub seda võtta kui tõsiasja ja mitte üritada tekitada organisatsioonilist muutust IT strateegia kaudu\\}
		\end{itemize}
