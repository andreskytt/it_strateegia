...
\begin{frame}[fragile]
  ...
  \end{center}
\end{frame}
\note{Lugege Joeli, ta on hea. Suurem osa sisu veebis tasuta saadaval aga raamat on mugavam \par Muidugi on toodud vastuolu vaid üks võimalikke, kuid illustreerib seoseid kenasti. \par Veelkord: kuidas te tarkvara ehitate, nagu ka kõik muu, mida te teete, peab toetama äristrateegiat}
...
\begin{frame}[fragile]
  ...
  \end{itemize}
\note{Shipping is a feature. A really important feature. Your product must have it. Spolsky, duct tape programmer}
\end{frame}
